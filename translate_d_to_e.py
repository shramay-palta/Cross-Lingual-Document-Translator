...
mat = np.load('C:/Users/RIJUL KATIYAR/Desktop/IR/modelDutoEng.npy')
...
f1 = open('C:/Users/RIJUL KATIYAR/Desktop/IR/test_d_to_e.txt',encoding = "utf8")
list1 = []
...
for i in range(len(list1)):	
	...
	list1[i] = str1
y = open("result_d_to_e.txt","a+",encoding = "utf-8")
y.seek(0)
y.truncate()
print(list1)
for input1 in list1:
	...
	output = list()
	for x in (l):
		if x in du_dict.keys():
			output.append(eng_dictn[np.argmax(mat[du_dict[x]])])
			#output.append(x)
